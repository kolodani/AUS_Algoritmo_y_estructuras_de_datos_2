{-
    ...
    mostrar que si tanto f como g son extrictas, entonces tambien h lo es.
-}
...
-- f (g x). si g x es extricta, entonces evaluara f (g x) y si f (g x) es
-- extricta, entonces h x es extricta.