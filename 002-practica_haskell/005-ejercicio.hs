...
-- foldr es una función de orden superior que permite definir funciones recursivas sobre listas.
-- funciona de la siguiente manera:
-- toma una función f, un valor inicial z y una lista xs
-- y aplica f a los elementos de xs, de izquierda a derecha, usando z como valor inicial.
