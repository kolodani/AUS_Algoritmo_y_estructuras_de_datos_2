...
mezclarColores :: Colores -> Colores -> Colores
mezclarColores (r1, g1, b1) (r2, g2, b2) = (div (r1 + r2) 2, div (g1 + g2) 2, div (b1 + b2) 2)

data Color = RGB Red Green Blue deriving (Show)

mezclarRGB :: Color -> Color -> Color
mezclarRGB (RGB r1 g1 b1) (RGB r2 g2 b2) = RGB (div (r1 + r2) 2) (div (g1 + g2) 2) (div (b1 + b2) 2)
